...
/// </summary>
class StageFourDialogueBackgroundScreen : GameScreen {
    #region Fields
    ...
    /// Constructor.
    /// </summary>
    public StageFourDialogueBackgroundScreen() : base() {
    ...
    public override void Update(GameTime gameTime, bool otherScreenHasFocus,
        ...
        for (int i = 0; i < StageFour.NUM_WALLS; i++) {
            background[i].SetTextureCoords(
                new Vector2(
                    (parallaxScroll / (15 + 5 * (StageFour.NUM_WALLS - i - 1)) + wallSheet[i].Width) / wallSheet.Width,
