...
/// </summary>
class StageTwoDialogueBackgroundScreen : GameScreen {
    #region Fields
    ...
    /// Constructor.
    /// </summary>
    public StageTwoDialogueBackgroundScreen() : base() {
    ...
    public override void Update(GameTime gameTime, bool otherScreenHasFocus,
        ...
        for (int i = 0; i < StageTwo.NUM_WALLS; i++) {
            background[i].SetTextureCoords(
                new Vector2(
                    (parallaxScroll / (15 + 5 * (StageTwo.NUM_WALLS - i - 1)) + wallSheet[i].Width) / wallSheet.Width,
