...
/// </summary>
class StageTwoBackgroundScreen : GameScreen {
    #region Fields
    ...
    /// Constructor.
    /// </summary>
    public StageTwoBackgroundScreen() : base() {
    ...
    public override void LoadContent() {
        ...
        wallSheet = new TextureSheet(content.Load<Texture2D>("Beatmaps/Chikutaku/Assets/ChikuTaku_Wall_Background"), StageTwo.NUM_WALLS + 1, 1);
        ...
        basicEffect.FogColor = StageTwo.BackgroundColor.ToVector3();
        ...
        background = new Quad(
            ...
            groundWidth,
            wallHeight,
            new Vector2(0, (float) wallSheet[StageTwo.NUM_WALLS].Y / (float) wallSheet.Height),
            (float) wallSheet[StageTwo.NUM_WALLS].Width / (float) wallSheet.Width,
            (float) wallSheet[StageTwo.NUM_WALLS].Height / (float) wallSheet.Height
        );

        for (int i = 0; i < StageTwo.NUM_WALLS; i++) {
            leftWall.Add(new Quad(
                new Vector3(-(groundWidth / 2) + StageTwo.WALL_OFFSET * i, wallWidth / 2, wallHeight / 2),
                new Vector3(1, 0, 0),
                new Vector3(0, 0, 1),
                wallWidth,
                wallHeight
    ...
    public override void Update(GameTime gameTime, bool otherScreenHasFocus,
        ...
        for (int i = 0; i < StageTwo.NUM_WALLS; i++) {
            leftWall[i].SetTextureCoords(
                new Vector2(
                    (groundScrollY / (15 + 15 * (StageTwo.NUM_WALLS - i - 1)) + wallSheet[i].Width) / wallSheet.Width,
    ...
    public override void Draw(GameTime gameTime) {
        ScreenManager.GraphicsDevice.Clear(ClearOptions.Target, StageTwo.BackgroundColor, 0, 0);
