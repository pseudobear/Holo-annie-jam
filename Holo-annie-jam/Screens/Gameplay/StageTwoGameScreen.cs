...
/// </summary>
class StageTwoGameScreen : GameScreen {
    #region Fields
    ...
    /// Constructor.
    /// </summary>
    public StageTwoGameScreen(string beatmapFilename) : base() {
    ...
    public override void LoadContent() {
        ...
        uprightObjectEffect.FogColor = StageTwo.BackgroundColor.ToVector3();
        ...
        shadowObjectEffect.FogColor = StageTwo.BackgroundColor.ToVector3();
        ...
        UIEffect.FogColor = StageTwo.BackgroundColor.ToVector3();
    ...
    void OnBeatmapEnd(object sender, PlayerIndexEventArgs e) {
        LoadingScreen.Load(ScreenManager, true, e.PlayerIndex,
            new PostStageTwoDialogueScreen()
        );
    }
    ...
    public override void Update(GameTime gameTime, bool otherScreenHasFocus, bool coveredByOtherScreen) {
        ...
        // Gura bob
        if (visibleEvents.Tick >= lastGuraBob + StageTwo.BOB_RATE) {
